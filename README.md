# German (de_DE) language pack for Maho ecommerce platform

This repository contains the de_DE language pack for the Maho e-commerce platform.
It provides localization support for the de_DE language and region.
...
```bash
composer require mahocommerce/maho-language-de_de
```
